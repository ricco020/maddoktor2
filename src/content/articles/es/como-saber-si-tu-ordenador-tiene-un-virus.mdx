...
Si un análisis confirma la infección, no entres en pánico. La mayoría se pueden eliminar. Pon en cuarentena o borra lo que marque el escáner y reinicia. Después sigue los pasos concretos para tu problema: nuestras guías cubren [cómo eliminar spyware](/es/articles/como-eliminar-spyware), [cómo eliminar un troyano](/es/articles/como-eliminar-un-troyano) y [cómo limpiar un secuestrador de navegador](/es/articles/como-eliminar-un-secuestrador-de-navegador). Si el malware era un ladrón de información o un keylogger, da por hecho que tus contraseñas guardadas quedaron expuestas.

<AffiliateCTA href="/go/proton-pass" product="Proton Pass" blurb="Si un ladrón de información pudo leer tus contraseñas guardadas, cámbialas desde un dispositivo limpio y guarda las nuevas con cifrado de extremo a extremo. Proton Pass las mantiene cifradas, así una futura infección no podrá leerlas sin más." />
