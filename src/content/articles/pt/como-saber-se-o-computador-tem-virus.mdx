...
<AffiliateCTA href="/go/proton-pass" product="Proton Pass" blurb="Se um ladrão de informação pode ter lido as suas palavras-passe guardadas, mude-as a partir de um dispositivo limpo e guarde as novas com encriptação ponta a ponta. O Proton Pass mantém-nas encriptadas para que uma infeção futura não as consiga simplesmente ler." />
