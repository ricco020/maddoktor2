...
Em resumo: um rootkit se esconde de qualquer verificacao que rode junto com ele, entao voce o vence verificando a partir de fora - Microsoft Defender Offline primeiro, midia de resgate inicializavel em seguida - e, para os mais enraizados, formatando e reinstalando. Para limpezas relacionadas, veja [como remover um virus trojan](/pt/articles/how-to-remove-a-trojan-virus) e o guia completo de [como remover malware do Windows](/pt/articles/how-to-remove-malware-from-windows).
