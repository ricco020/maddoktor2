...
![Una persona seduta di notte in una stanza buia, che guarda un telefono accanto a uno schermo di computer acceso](https://images.pexels.com/photos/17486595/pexels-photo-17486595.jpeg?auto=compress&cs=tinysrgb&h=650&w=940)

## Passaggio 3: esegui uno scanner su richiesta per un secondo parere

Parte dello spyware sfugge a qualsiasi singolo motore. Esegui uno scanner su richiesta affidabile come secondo parere: opzioni note includono lo scanner gratuito di Malwarebytes e ADWCleaner (che colpisce adware, PUP e dirottatori del browser). Eseguire uno scanner su richiesta insieme a Defender va bene, perché analizza su richiesta anziché far girare un secondo motore in tempo reale. Metti in quarantena ciò che segnala e riavvia. Se poi svuotare quella lista di quarantena, e quanto costa davvero eliminare, è trattato in [devo eliminare i file in quarantena?](/it/articles/devo-eliminare-i-file-in-quarantena).
...
Letture correlate: [Il mio telefono è stato hackerato? I segnali che contano davvero](/it/articles/il-mio-telefono-e-stato-hackerato) · [Rimuovere un virus da iPhone](/it/articles/rimuovere-un-virus-da-iphone)
