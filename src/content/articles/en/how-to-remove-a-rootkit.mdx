...
Rootkits are not the only family built to be invisible: [fileless malware](/articles/what-is-fileless-malware) takes the opposite route and never writes a file to disk at all, which defeats scanners that look for one. The removal logic differs, so it is worth knowing which of the two you are facing before you start.
