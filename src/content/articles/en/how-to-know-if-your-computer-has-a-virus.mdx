...
Related reading: [Cryptojacking](/articles/what-is-cryptojacking) · [How to Remove a Pop-Up Virus](/articles/how-to-remove-pop-up-virus)

One category is worth ruling out before any of the checks above: an alert that appeared in a browser tab. [Scareware](/articles/what-is-scareware) stages a scan it could not have run, and the machine it warned you about is usually clean.
