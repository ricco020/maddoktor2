...
export const ui: Record<string, Strings> = {
  en: {
    ...
    nav_guides: 'Guides', nav_charter: 'Charter', nav_heritage: 'Heritage', nav_about: 'About',
  ...
  fr: {
    ...
    nav_guides: 'Guides', nav_charter: 'Charte', nav_heritage: 'Héritage', nav_about: 'À propos',
  ...
  es: {
    ...
    nav_guides: 'Guías', nav_charter: 'Carta', nav_heritage: 'Legado', nav_about: 'Acerca de',
  ...
  de: {
    ...
    nav_guides: 'Anleitungen', nav_charter: 'Charta', nav_heritage: 'Geschichte', nav_about: 'Über uns',
  ...
  it: {
    ...
    nav_guides: 'Guide', nav_charter: 'Statuto', nav_heritage: 'Storia', nav_about: 'Chi siamo',
  ...
  pt: {
    ...
    nav_guides: 'Guias', nav_charter: 'Carta', nav_heritage: 'História', nav_about: 'Sobre',
